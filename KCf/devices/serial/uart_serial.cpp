...
void SerialPort::updateReceiveInformation() {
  ...
  // for(size_t i = 0;i!=sizeof(receive_data_.Receive_Red_HP);++i)
  // {
  //   receive_data_.Receive_Red_HP.R_Base_HP;
  // }
  ...
  // for (size_t i = 0; i != sizeof(receive_data_.Receive_Red_Information.arr_yaw_angle); ++i) {
