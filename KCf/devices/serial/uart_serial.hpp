...
namespace uart
{
  ...
  static auto idntifier_green = fmt::format(fg(fmt::color::green) | fmt::emphasis::bold, "uart_serial");
  static auto idntifier_red = fmt::format(fg(fmt::color::red) | fmt::emphasis::bold, "uart_serial");
...
struct Write_Data {
   ...
   * @return float
   */
    // inline uint16_t returnReceiveReceive_Information() { return receive_data_.Receive_Information; }
    /**
   * @brief 返回子弹速度
   * 
   * @return int 
